...
lora_dropout=0.1
LR=2e-4
model_name_or_path="./models/models--THUDM--chatglm-6b/snapshots/a8ede826cf1b62bd3c78bdfb3625c7c5d2048fbd"   # LLM底座模型路径，或者是huggingface hub上的模型名称
...
STEP=1000    # 用来评估的模型checkpoint是训练了多少步
